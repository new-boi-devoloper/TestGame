...
namespace PojectScripts
{
    public class Game : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            //SHOP
            shop1Text.text = "Мелкий пассив: " + Math.Floor(shop1Prize);
            shop2Text.text = "Средний пассив: " + Math.Floor(shop2Prize);
        
            //AMOUNT OF BOUGHT PASSIVES
            amount1Text.text = $"Куплено: {amount1} текущий пассив: {amount1Profit}/s";
            amount2Text.text = $"Куплено: {amount2} текущий пассив: {amount2Profit}/s";
